module Views where
import Data (Vnode)
import Mithril (MithrilDomNode, a, className, div_, h1, hr, i, li, li_, mp, span_, text, ul)
...
navbar = { view: \ctrl ->
  [ ul [ className "menu" ]
    ...
    , li [ className "active" ] [ a [ href "http://www.amd.com" ] [ text "Amd" ] ]
    , li_ [ a [ href "http://www.nvidia.com" ]
            [ i [ className "fa fa-money" ] [ span_ "Two" ] ] ]
    , li_ [ mp "a" [ href "http://www.hp.com" ]
